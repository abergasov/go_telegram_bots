...
type Request struct {
	...
	TargetChat int32 `protobuf:"varint,1,opt,name=targetChat,proto3" json:"targetChat,omitempty"`
}
...
func (x *Request) GetTargetChat() int32 {
	if x != nil {
		return x.TargetChat
	}
	return 0
...
var file_api_command_streamer_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x43, 0x68, 0x61,
